                        ...
                        <div class="card-body">
                            <form enctype="multipart/form-data" method="POST" action="{{ route('admin.create') }}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="newsTitle" type="text" class="form-control" name="title" value="{{ old('title') }}" >
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <textarea class="form-control" name="text" id="newsText" cols="30" rows="10">{{ old('text') }}</textarea>
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    <div class="col-md-6 offset-md-4">
                                        <div class="form-check">
                                            <input @if (old('isPrivate') === "1") checked @endif class="form-check-input" type="checkbox" id="newsPrivate" name="isPrivate" value="1">
